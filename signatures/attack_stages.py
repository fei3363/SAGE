...
class MicroAttackStage(Enum):
    ...
    POINT_AND_TAG_IDENTIFICATION = 200
    PROGRAM_DOWNLOAD = 201
    PROGRAM_UPLOAD = 202
    MODIFY_CONTROLLER_TASKING = 203
    MODIFY_CONTROL_LOGIC = 204
    MODIFY_PARAMETERS = 205
    CHANGE_OPERATING_MODE = 206
