...
print('------ ABLATION B: Learning Prefix Tree (instead of S-PDFA) ------')
# Import prefix tree implementation
import sys
sys.path.append(os.path.dirname(os.path.abspath(__file__)))
from prefix_tree import PrefixTree

# Build prefix tree from traces
prefix_tree = PrefixTree()
prefix_tree.build_from_traces_file(path_to_traces)
print(f"Prefix tree built with {prefix_tree.get_num_states()} states")

# Save the model
prefix_tree.save_model(path_to_traces + ".prefix_tree.model")

# For compatibility, create empty files that SAGE expects
open(path_to_traces + ".ff.final.dot", 'w').close()
open(path_to_traces + ".png", 'w').close()
